...
#define USBGEN_EP_SIZE          16
#define USBGEN_EP_SIZE_MSB      (USBGEN_EP_SIZE & 0xFF00) >> 8u
#define USBGEN_EP_SIZE_LSB      (USBGEN_EP_SIZE & 0x00FF)
...
#define USB_STATUS_STAGE_TIMEOUT     (BYTE)100   //Approximate timeout in milliseconds, except when
